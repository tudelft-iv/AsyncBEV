...
learned_bev_warping = 'motion_with_loss'
flow_modal = 'multi'
...
exp_id = f'cmt_nus_LC_full_two_stage_a40_ep{total_epochs}_async_lidar_random_w_learned_bev_warping_{learned_bev_warping}_multi_modal_src_wo_pe_emc_encoding_daic'
##
