...
exp_id = f'cmt_nus_LC_full_two_stage_a40_ep{total_epochs}_async_cam_random_w_learned_bev_warping_{learned_bev_warping}_multi_modal_src'
##
...
load_from=None #'checkpoints/CMT/fcos3d_vovnet_imgbackbone-remapped.pth'
