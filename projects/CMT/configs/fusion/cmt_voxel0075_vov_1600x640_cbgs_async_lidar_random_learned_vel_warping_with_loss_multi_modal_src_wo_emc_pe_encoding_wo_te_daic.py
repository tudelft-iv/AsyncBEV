...
exp_id = f'cmt_nus_LC_full_two_stage_a40_ep{total_epochs}_async_lidar_random_w_learned_bev_warping_{learned_bev_warping}_multi_modal_src_wo_emc_pe_encoding_wo_te_daic_lr_{lr}_new'
##
...
train_pipeline = [
    ...
    dict(
        ...
        early_motion_compensation = early_motion_compensation,
        remove_close=True
    ),
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        use_emc_pe_encoding = use_emc_pe_encoding,
...
resume_from = None #'outputs/train/cmt_nus_LC_full_two_stage_a40_ep12_async_lidar_random_w_learned_bev_warping_vel_with_loss_multi_modal_src_daic/epoch_6.pth'
workflow = [('train', 1)]
# gpu_ids = range(0, 8)
