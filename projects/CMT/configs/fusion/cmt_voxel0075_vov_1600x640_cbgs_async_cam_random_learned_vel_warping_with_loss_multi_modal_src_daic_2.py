...
## Async settings
eval_async_frame = 0
bev_warping_modality = 'cam'
learned_bev_warping = 'vel_with_loss'
flow_modal = 'multi'
loss_voxel_flow = dict(
    type = 'VoxelFlowLoss',
    loss_weight = 0.2
)
lr=2e-5
...
async_file_map_path = 'async_supplement/cams_sample_sweeps_map_ego_sample_w_ego_pose_timestamp.pkl'
exp_id = f'cmt_nus_LC_full_two_stage_a40_ep{total_epochs}_async_cam_random_w_learned_bev_warping_{learned_bev_warping}_lr_{lr}_multi_modal_src_daic'
##
ckpg_save_interval = 1
eval_interval = 2
...
load_from='checkpoints/CMT/voxel0075_vov_1600x640_epoch20.pth'
...
train_pipeline = [
    ...
    dict(type='LoadMultiViewAsyncImageFromFiles',
         to_float32=True,
    ...
    dict(
        ...
        flow_folder=data_root + 'async_supplement/async_cam_flow',
    ),
    # dict(
    ...
    #         data_root=data_root + 'mmdet3d_cmt',
    #         info_path=data_root + 'mmdet3d_cmt/nuscenes_dbinfos_train.pkl',
    #         rate=1.0,
    #         prepare=dict(
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        learned_bev_warping = learned_bev_warping,
        ...
        loss_voxel_flow=loss_voxel_flow,
    ),
    train_cfg=dict(
        pts=dict(
            dataset='nuScenes',
...
resume_from = None # 'outputs/train/cmt_nus_LC_full_two_stage_a40_ep12_async_cam_random_w_learned_bev_warping_vel_with_loss_multi_modal_src_daic/epoch_4.pth'
workflow = [('train', 1)]
# gpu_ids = range(0, 8)
