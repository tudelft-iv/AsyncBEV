...
load_from='checkpoints/CMT/fcos3d_vovnet_imgbackbone-remapped.pth'
...
resume_from = '/home/shimingwang/workspace/mmdet3d_v100rc5/outputs/train/cmt_voxel0075_vov_1600x640_cbgs/epoch_8.pth'
workflow = [('train', 1)]
# gpu_ids = range(0, 8)
