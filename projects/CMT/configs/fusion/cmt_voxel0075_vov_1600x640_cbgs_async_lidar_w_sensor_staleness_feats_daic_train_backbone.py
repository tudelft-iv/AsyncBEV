...
eval_async_frame = 0
lr = 2e-4
bev_warping_modality = None
learned_bev_warping = None
flow_modal = None
early_motion_compensation = False
sensor_staleness_feats = True

loss_voxel_flow = None
random_sampling = True
freeze_backbone = False
async_file_map_path = 'async_supplement/lidar_sample_sweeps_map_w_extrin_ego_sample_ref_coord.pkl'
exp_id = f'cmt_nus_LC_full_two_stage_a40_ep{total_epochs}_async_lidar_random_daic_w_sensor_staleness_feats_train_backbone_lr_{lr}'
##
...
train_pipeline = [
    ...
    dict(
        ...
        sensor_staleness_feats=sensor_staleness_feats,
        remove_close=True
    ),
...
resume_from = None #'outputs/train/cmt_nus_LC_full_two_stage_a40_ep12_async_lidar_random_daic_w_sensor_staleness_feats_train_backbone_lr_2e-05_continue/epoch_8.pth'
workflow = [('train', 1)]
# gpu_ids = range(0, 8)
