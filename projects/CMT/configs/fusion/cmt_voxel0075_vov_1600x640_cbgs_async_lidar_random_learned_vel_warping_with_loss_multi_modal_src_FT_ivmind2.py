...
exp_id = f'cmt_nus_LC_full_two_stage_a40_ep{total_epochs}_async_lidar_random_w_learned_bev_warping_{learned_bev_warping}_lr_{lr}_multi_modal_src_ivmind2_FT'
##
